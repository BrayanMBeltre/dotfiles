...
ThemeManager.prototype = {
  ...
  initSnackBar: function () {
    (function ($) {
      ...
      $.fn.snackbar = function (message, actionTitle, callback) {
        ...
        var _sb_content = $(
          '<span class="snackbar-content disableSelector">SNACKBAR</span>'
        );
  ...
  initPassowrdInput: function () {
    ...
    $(".input-password button").click(function () {
      ...
      $(this).attr(
        "title",
        $(input).attr("type") === "password" ? "show password" : "hide password"
      );
    });
  ...
  initButtons: function () {
    ...
    $("#control-shutdown").click(function () {
      manager.createAlert(
        "Shutdown",
        "Do you Want to shutdown System?",
        function () {
          lightdm.shutdown();
        }
      );
    ...
    $("#control-hibernate").click(function () {
      manager.createAlert(
        "Hibernate",
        "Do you Want to Hibernate System?",
        function () {
          lightdm.hibernate();
        }
      );
  ...
  authUser: function (password) {
    loginUser(
      lightdm.users[_currentUserId].name,
      password,
      function () {
        // SUCCESS
        //alert("SUCCESS");
  ...
  updateSessionId: function (pos) {
    ...
    _currentUserSessionId = lightdm.sessions
      .map(function (e) {
        return e.key;
      })
      .indexOf(_session);
  ...
  getUserInfo: {
    ...
    userImage: function () {
      return lightdm.users[_currentUserId].image !== null
        ? lightdm.users[_currentUserId].image
        : _defaultUserImage;
    },
  },
  ...
  updateTime: function () {
    ...
    $("#clock-date-date").html(
      _date.getDate() + " " + this._months[_date.getMonth()]
    );
  ...
  addUserButton: function (user, pos) {
    ...
    $(userBtn)
      .find("img")
      .attr("src", user.image !== null ? user.image : _defaultUserImage);
