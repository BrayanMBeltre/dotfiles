class SettingsKeybinds {
  constructor() {
    ...
    this._keyBindModifierInput = document.querySelector(
      "#keyBindModifierInput"
    );
    this._keyBindModifiersShow = document.querySelectorAll(
      "#keyBindModifierShow"
    );
    ...
    this._keyBindSettingsInput = document.querySelector(
      "#keyBindSettingsInput"
    );
    ...
    this._settingsApplyKeybinds = document.querySelector(
      "#settingsApplyKeybinds"
    );
    this._settingsResetKeybinds = document.querySelector(
      "#settingsResetKeybinds"
    );
  ...
  _settingsApplyKeybindsClickEvent() {
    this._settingsApplyKeybinds.addEventListener("click", () => {
      this._settingsKeybindsApply();
    });
  }

  _settingsResetKeybindsClickEvent() {
    this._settingsResetKeybinds.addEventListener("click", () => {
  ...
  _keyBindModifierInputEvents() {
    ...
    this._keyBindModifierInput.addEventListener("keyup", (e) => {
      return false;
    });
  }
  ...
  _updateKeyBindingsObj() {
    this._keyBindingsObj = {
      defaultModifierKey:
        this._keyBindModifierInput.value ||
        this._storageGetItem("defaultModifierKey") ||
        "Alt",
      defaultSessionKey:
        this._keyBindSessionInput.value ||
        this._storageGetItem("defaultSessionKey") ||
        "s",
      defaultPowerKey:
        this._keyBindPowerInput.value ||
        this._storageGetItem("defaultPowerKey") ||
        "e",
      defaultSettingsKey:
        this._keyBindSettingsInput.value ||
        this._storageGetItem("defaultSettingsKey") ||
        "x",
      defaultUsersKey:
        this._keyBindUsersInput.value ||
        this._storageGetItem("defaultUsersKey") ||
        "y",
      defaultCloseKey:
        this._keyBindCloseInput.value ||
        this._storageGetItem("defaultCloseKey") ||
        "*",
    };
  ...
  _updateKeyBindingsDefault() {
    Object.keys(this._keyBindingsObj).forEach((key, index) => {
