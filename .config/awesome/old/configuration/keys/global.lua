...
local globalKeys = awful.util.table.join(
    ...
    --),
      ...
      awful.key(
        ...
        'Print',
        function()
          awful.util.spawn_with_shell('flameshot gui && flameshot full -p ~/Pictures/Screenshots/')
        end
      ),
    ...
    awful.key(
        ...
        'Delete',
        function()
            awful.spawn(apps.default.terminal .. ' ' .. 'gotop')
        end,
  ...
  -- awful.key({ modkey }, "d", function () awful.util.spawn(" ./.config/rofi/launchers/launcher.sh ") end,
  --     {description = "open application drawer", group = 'launcher'}),
